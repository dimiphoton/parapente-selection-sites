...
(justification : ``docs/overlay.md``). Le filtre vent (Open-Meteo,
3 jours, ± 45°) est dans ``sites_parapente.wind`` (``docs/wind.md``).
Le MNT LiDAR et le raster WALOUS se posent dans `data/raw/` (non commité).
"""
