...
| 2026-08-30 | FME **obligatoire** pour l'intégration, installé plus tard | ETL 100 % Python/GDAL | Brief de montée en compétence outil. Si FME n'est pas là au moment de l'étape, l'autopilot écrit `.cursor/autopilot.pause`. |
